...
<input type="Date" class="form-control" placeholder="" id="inputDefault"/>

<label class="col-form-label" for="inputDefault">Start Time</label>
<input type="time" class="form-control" placeholder="" id="inputDefault"/>
...
<textarea class="form-control" rows="5" id="StatusUntilNow"></textarea>

<label class="col-form-label" for="inputDefault">Agenda</label>
<textarea class="form-control" rows="5" id="inputDefault"></textarea>
